...
function Assets(){
  ...
  return(
    <div style={{
      ...
      <div style={{background:"#171b22",padding:"15px",borderRadius:"12px",marginBottom:"20px"}}>

        <div style={{fontSize:"14px",color:"#999"}}>عنوان محفظة USDT (TRC20)</div>

        <input value="TQ9xYourWalletAddressxxxxxxxxxxxxx" readOnly style={{width:"100%",padding:"10px",marginTop:"10px"}} />

        <br/><br/>

        <button onClick={()=>{navigator.clipboard.writeText("TQ9xYourWalletAddressxxxxxxxxxxxxx");alert("تم نسخ العنوان");}}>📋 نسخ العنوان</button>
